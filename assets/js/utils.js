...
window.Utils = (function () {
    ...
    if (attrs) {
      Object.keys(attrs).forEach(function (key) {
        ...
        if (key === 'textContent') {
          ...
          // التغيير: على الصفحات بدون unsafe-inline، تجاهل الـ style بالكامل
          if (window.location.pathname.indexOf('/course/course-details/') === -1) {
            console.warn('el(): inline style blocked on CSP-restricted page');
            return; // لا تطبّق الـ style
          }
  ...
  function showToast(msg, type) {
    ...
    var toastEl = el('div', {
      className: 'toast align-items-center border-0 show' + typeClass,
      role: 'alert',
      ...
      el('div', { className: 'd-flex' }, [
        ...
        el('button', {
          type: 'button',
          className: 'btn-close ' + (getLang() === 'ar' ? 'ms-2' : 'me-2') + ' m-auto',
