...
(function () {
  ...
  function buildBreadcrumb() {
    var homeLinks = U.qsa('.legal-breadcrumb a');
    ...
    var current = U.qs('.legal-breadcrumb li[aria-current="page"]');
    if (current) {
      current.textContent = isTerms ? U.t(META.termsPageTitle) : U.t(META.privacyPageTitle);
    }
  }
