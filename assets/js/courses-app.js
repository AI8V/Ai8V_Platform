...
(function () {
  ...
  function setupPageHeader() {
    ...
    if (breadcrumbHome) {
      ...
      var homeIcon = U.el('i', { className: 'bi bi-house-door-fill', aria: { hidden: 'true' } });
    ...
    /* lang switcher is in the navbar — populated by SP.buildNavBrand() */
  ...
  function buildCard(course, idx) {
    var iconGap     = U.getLang() === 'ar' ? 'ms-1' : 'me-1';
    ...
    var instructorEl = U.el('span', { className: 'course-card-meta-item' }, [
      U.el('i', { className: 'bi bi-person-fill ' + iconGap, aria: { hidden: 'true' } }),
      instructor
    ]);

    var lessonsText = U.t(META.lessonsLabel).replace('{n}', String(course.lessons));
    var statsRow = U.el('div', { className: 'course-card-meta' }, [
      U.el('span', { className: 'course-card-meta-item' }, [U.el('i', { className: 'bi bi-people-fill ' + iconGap, aria: { hidden: 'true' } }), U.formatNumberByLang(course.students)]),
      U.el('span', { className: 'course-card-meta-item' }, [U.el('i', { className: 'bi bi-book-fill ' + iconGap,   aria: { hidden: 'true' } }), lessonsText]),
      U.el('span', { className: 'course-card-meta-item' }, [U.el('i', { className: 'bi bi-star-fill ' + iconGap,   aria: { hidden: 'true' } }), String(course.rating)])
    ]);
    ...
    var ariaLabel = U.t(META.courseCardAria).replace('{title}', title);
    var btn = U.el('a', { className: 'course-card-btn', href: href, textContent: viewLabel, aria: { label: ariaLabel } });
